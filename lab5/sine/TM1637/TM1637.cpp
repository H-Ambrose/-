...
void TM1637::set(uint8_t brightness, bool on)
{
...
void TM1637::display(int8_t DispData[])
{
    ...
    for (uint8_t i = 0;i < 4; ++i)
        SegData[i] = digitToSegment[DispData[i] & 0x0f];
    setSegments(SegData);
}

void TM1637::display(uint8_t BitAdd, int8_t DispData)
{
    uint8_t k = digitToSegment[DispData & 0x0f];
    setSegments(&k, 1, BitAdd);
}
